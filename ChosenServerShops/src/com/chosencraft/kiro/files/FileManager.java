...
public class FileManager {
	...
	public static final FileManager data = new FileManager("data");
	 ...
	 * 
	 * @param playerUUID
	 *            UUID of player to be saved.
	 * @param info
	 *            Info array, of Strings with format
	 *            (permissionNode;timeInSeconds)
	 */
	public void savePlayerData(UUID playerUUID, String[] info) {
		if (info != null) {
			String moddifable = "";
			for (String string : info) {
				moddifable += (":" + string + ";" + System.currentTimeMillis());
			}
	 ...
	 * 
	 * @param playerUUID
	 *            UUID of player to be loaded.
	 * @return info in form of String[permission #] where string =
	 *         (permissionNode;timeInSeconds;previousCurrentMill)
	 */
	public String[] loadPlayerData(UUID playerUUID) {
		// In format of UUID:permission;time;previousCurrentMill...
		String[] info;
	 ...
	 * 
	 * @param playerUUID
	 *            UUID of player to be checked.
	 * @return if the player has special Permissions
	 * 
	 *         Uses Current Array List
	 */
	 ...
	 * @param playerUUID
	 *            UUID of Player to be checked.
	 * @return Returns if the player should be given permissions.
	 * 
	 *         Grabs from file.
	 */
